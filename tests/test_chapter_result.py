...
class TestFormatChapterResult:
    ...
    def test_returns_structured_format(self, mock_store):
        ...
        result = _format_chapter_result("book_123", "abc12345xyz", "第2章", "这是一段测试内容，讲述了主角的冒险故事。")
    ...
    def test_no_hallucination_keywords(self, mock_store):
        ...
        result = _format_chapter_result("book_123", "abc12345", "第1章", "测试内容")
    ...
    def test_progress_without_outline(self, mock_store):
        ...
        result = _format_chapter_result("book_123", "abc12345", "第3章", "内容")
    ...
    def test_content_preview_truncated(self, mock_store):
        ...
        long_content = "A" * 500
        result = _format_chapter_result("book_123", "abc12345", "长章节", long_content)
    ...
    def test_extra_info_appended(self, mock_store):
        ...
        result = _format_chapter_result(
            "book_123", "abc12345", "第1章", "内容", extra="知识范围: 人物: 叶凡, 林婉 | 禁止: 苏晴"
        )
    ...
    def test_word_count_accurate(self, mock_store):
        ...
        result = _format_chapter_result("book_123", "abc12345", "测试章节", content)
