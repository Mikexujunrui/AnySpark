...
from core.simulation.character_agent import CharacterAgent
...
def test_build_profiles_batch(agent, mock_graph):
    ...
    def get_entity(eid):
        if eid == "char_001":
            return Entity(id="char_001", type=EntityType.CHARACTER, name="张三", data={"description": "剑客"})
        elif eid == "char_002":
            return Entity(id="char_002", type=EntityType.CHARACTER, name="李四", data={"description": "书生"})
        return None
