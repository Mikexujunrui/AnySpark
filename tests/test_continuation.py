        ...
        db = AnnotationDatabase(
            ...
            entries=[
                AnnotationEntry(
                    ...
                    target_text="",
                    comment_text="",
                    comment_type=AnnotationType.PLOT_HINT,
                    implied_outcome="a",
                    certainty=AnnotationCertainty.HIGH,
                    related_characters=[],
                    must_fulfill=False,
        ...
        db = AnnotationDatabase(
            ...
            entries=[
                ...
                AnnotationEntry(
                    ...
                    target_text="",
                    comment_text="",
                    comment_type=AnnotationType.CHARACTER_FATE,
                    implied_outcome="",
                    certainty=AnnotationCertainty.MEDIUM,
                    related_characters=[],
                    must_fulfill=False,
                ),
            ],
            ...
            db = AnnotationDatabase(
                ...
                entries=[
                    AnnotationEntry(
                        ...
                        comment_text="此联妙极",
                        comment_type=AnnotationType.TECHNIQUE_COMMENT,
                        implied_outcome="真假呼应",
                        certainty=AnnotationCertainty.HIGH,
                        related_characters=["角色甲", "角色乙"],
                        must_fulfill=False,
                    ),
                ],
            )
