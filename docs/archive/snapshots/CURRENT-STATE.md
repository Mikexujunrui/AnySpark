...
> 生成：2026-08-15 03:54 UTC · commit `ffc383a S152: 预置模板保护（builtin）——系统模板固定不可删（主人架构观点落地）` · 阶段 S147 · **非手写**：
...
| 前端入口 | **27** 个 tab |
| 测试 | **605** 个 |
| 后端代码 | **28306** 行（align 4376, app 16697, check 555, core 1529, explore 837, graph 1518, template 1083, workflow 1711） |
