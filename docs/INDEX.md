...
| [MODULES.md](MODULES.md) | 开发者 | 模块定义与实现状态，含接口说明和依赖关系 |
| [ROADMAP.md](ROADMAP.md) | 项目经理、贡献者 | 开发路线图（历史规划）与版本历史（v4-v12 实施记录） |
| [IMPROVEMENTS.md](IMPROVEMENTS.md) | 贡献者 | 改进跟踪（18/18 项已完成），变更日志与新增文件清单 |

## 阅读顺序建议

1. **新成员入门**：README.md → TECH_STACK.md → ARCHITECTURE.md
2. **模块开发**：MODULES.md → ARCHITECTURE.md（对应分层）
3. **架构决策**：ARCHITECTURE.md → IMPROVEMENTS.md
4. **规划新功能**：ROADMAP.md → MODULES.md → IMPROVEMENTS.md
5. **参与贡献**：CONTRIBUTING.md → SECURITY.md
