...
async def _generate_workflow_streaming(loop, args: dict, book_id: str, queue):
...
async def _execute_workflow_streaming(loop, args: dict, book_id: str, queue):
        ...
        try:
            ...
            if not steps:
                ...
                for i, step in enumerate(steps):
                    ...
                    lines.append("")
            lines.append("**提示**: 使用 `update_workflow_step(workflow_id, step_index, config)` 可修改特定步骤的参数。")
