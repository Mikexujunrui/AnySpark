    ...
    try:
        while not state.exhausted:
            ...
            _NOOP_READ_ONLY_TOOLS = frozenset({
                "search_knowledge", "search_graph", "search_reference",
                "read_chapter", "read_document",
                "get_outline", "get_detailed_outline", "get_worldbuilding",
                "get_timeline", "get_style", "get_graph_insights",
                "list_chapters", "list_styles", "list_skills", "list_volumes",
                "list_references", "list_reference_chapters",
                "list_workflows", "browse_workflows", "browse_materials",
                "search_materials", "count_words", "chapter_history",
