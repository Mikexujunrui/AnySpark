...
class SimulationStore:
    ...
    def update_session(self, sim_id: str, **kwargs) -> dict | None:
        ...
        allowed = {"status", "summary", "turn_count", "setting", "condition",
                    "current_branch"}
        ...
        merged = {**latest_meta, **updates, "ts": datetime.now(timezone.utc).isoformat()}
    ...
    def add_choice(self, event_id: str, sim_id: str, text: str,
                   description: str = "", choice_type: str = "action") -> dict:
    ...
    def add_character_response(self, sim_id: str, event_id: str, character_id: str,
                               response_text: str, internal_thoughts: str = "") -> dict:
        response = {
            "id": str(uuid.uuid4()),
            "simulation_id": sim_id,
            "event_id": event_id,
    ...
    def add_event(self, sim_id: str, content: str, event_type: str = "narrative",
                  turn_number: int = 0, character_id: str | None = None) -> dict:
    ...
    def build_memory_context(self, sim_id: str, recent_limit: int = 6,
                              summary_max_chars: int = 2000) -> tuple[str, list[dict]]:
