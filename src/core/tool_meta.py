...
WRITE_TOOLS = {"extract_knowledge", "store_chapter", "write_chapter", "manage_notes",
               ...
               # ── 以下为之前遗漏的写入工具 ──
               "delegate_writing", "patch_chapter",
               "migrate_reference_knowledge", "import_reference_chapters",
               "start_autopilot", "reorder_chapters",
               "define_constraint", "delete_constraint",
               "resolve_foreshadow", "update_worldbuilding_entry",
