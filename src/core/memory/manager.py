...
class _NullProjectHelper:
    def get_premise(self, book_id):
        return ""

    def set_premise(self, book_id, premise):
        pass

    def get_notes(self, book_id):
        return []

    def add_note(self, book_id, title, content):
        return {"id": ""}

    def delete_note(self, book_id, note_id):
        return False

    def get_decisions(self, book_id):
        return []

    def record_decision(self, book_id, title, rationale):
        return {"id": ""}

    def delete_decision(self, book_id, decision_id):
        return False

    def get_progress_notes(self, book_id):
        return []

    def add_progress_note(self, book_id, content):
        return {"id": ""}

    def delete_progress_note(self, book_id, note_id):
        return False

    def get_tags(self, book_id):
        return []

    def set_tags(self, book_id, tags):
        pass

    def get_full_snapshot(self, book_id):
        return {}

    def format_tier1_index(self, book_id):
        return ""

    def format_tier0(self, book_id):
        return ""
...
class _NullPrefHelper:
    ...
    def match_by_keywords(self, k):
        return []

    def detect_keywords_from_text(self, t):
        return []

    def format_tier0(self):
        return ""

    def format_tier1(self):
        return ""

    def format_pending_summary(self):
        return ""


class _NullTriggerEngine:
    def check_tier2_promotion(self, *a, **kw):
        return ""

    def extract_keywords_from_scope(self, *a):
        return []
