...
class UserPreferenceHelper:
    ...
    def list_by_category(category: str) -> list[MemoryEntry]:
        ...
        return [
            ...
            if e.active and (e.category == category or e.category.startswith(category + "."))
        ]
    ...
    def match_by_keywords(input_keywords: list[str]) -> list[MemoryEntry]:
        ...
        all_entries = [e for e in load_preferences() if e.active and e.confidence in (
