"""[DEPRECATED] Interactive Story Store — Neo4j-backed branch story data model.

.. deprecated:: 2.0
    This module is superseded by ``core.simulation.simulation_store.SimulationStore``.
    It uses the old StoryBranch/BranchEvent/Choice labels that pollute the main
    knowledge graph. New code should use SimulationStore with Sim namespace
    isolation instead.
