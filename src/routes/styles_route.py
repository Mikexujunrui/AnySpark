...
@router.get("/styles")
def list_styles(source: str = None):
...
def set_narrative_strategy(book_id: str, data: NarrativeStrategyUpdate):
    ...
    try:
        ...
        return {"ok": True, "narrative_strategy": {
            "pov": strategy.pov, "pacing_curve": strategy.pacing_curve,
            "reveal_density": strategy.reveal_density, "foreshadow_budget": strategy.foreshadow_budget,
            "chapter_arc": strategy.chapter_arc, "tone_guidance": strategy.tone_guidance,
        }}
...
def get_narrative_strategy(book_id: str):
    ...
    if ns:
        return {"pov": ns.pov, "pacing_curve": ns.pacing_curve,
                "reveal_density": ns.reveal_density, "foreshadow_budget": ns.foreshadow_budget,
                "chapter_arc": ns.chapter_arc, "tone_guidance": ns.tone_guidance}
    return {"pov": "", "pacing_curve": "", "reveal_density": "",
            "foreshadow_budget": 3, "chapter_arc": "", "tone_guidance": ""}
