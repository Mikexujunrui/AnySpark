...
def create_book(book: BookCreate):
    new_book = json_store.create_book(book.title, book.description, book.genre)
...
@router.get("/genres")
def list_genres():
    """List all available content genres."""
    from core.genre_config import list_genres as _list_genres
    return _list_genres()
