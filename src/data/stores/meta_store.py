...
class MetaStoreMixin:
    ...
    def add_material(
        self, title: str, content: str, tags: list[str] | None = None, source: str = "", source_url: str = ""
    ) -> dict:
        with book_lock("_global"):
    ...
    def update_task_item(
        self, book_id: str, task_list_id: str, index: int, status: str, result_summary: str = None
    ) -> dict:
