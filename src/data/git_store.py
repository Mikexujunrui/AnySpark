...
class GitStore:
    ...
    def add_chapter(self, title: str, content: str, status: str = "draft") -> dict:
        ...
        return {"id": ch_id, "title": title, "content": content,
                "current_version": oid, "version_count": 1, "status": status}

    def edit_chapter(self, chapter_id: str, content: str,
                     title: str = None, message: str = "edit") -> dict:
        self._check_git()
        ...
        return {"id": chapter_id, "title": title, "content": content,
                "current_version": oid, "version_count": -1}
    ...
    def diff_chapters(self, chapter_id: str, version_a: str,
                      version_b: str = "") -> str:
        self._check_git()
        repo = self._repo_open()
        try:
